...
const showCharacters = (characters) => {
    ...
    for (let { image, name, id } of characters) {
        $("#charcaters-container").innerHTML += `
            ...
            <a href="#" class='btn btn-info mb-2' onclick=getCharacterById(${id})>Ver detalles</a>
        </div>
        `;
    }
};
...
const showCharacterDetail = ({
    ...
    <div class="card col-4">
        ...
        <a href="#" class='btn btn-danger mb-2' onclick=showView("charcaters-container")>Volver</a>
    </div>`;
};
